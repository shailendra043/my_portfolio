                ...
                >
                    <label className='flex flex-col'>
                        ...
                        <input
                            ...
                            className='bg-tertiary py-4 px-6 placeholder:text-secondary text-black dark:text-white rounded-lg outline-none border-none font-medium'
                        />
                    </label>
                    <label className='flex flex-col'>
                    ...
                    <button
                        type='submit'
                        className='bg-tertiary py-3 px-8 rounded-xl outline-none w-fit text-black dark:text-white font-bold shadow-md shadow-primary'
                    >
